...
def train_model(infile, embeddings):
    ...
    num_feats = 100
    nodes_node1, children_node1, nodes_node2, children_node2, h_ = network_test.init_net_finetune(num_feats,embeddingg)
    aaa = 1
    res=network_test.computCos(h_)
    labels_node, loss_node = network_test.loss_layer(res)
